...
import pickle
if os.path.exists('weibo_train.pkl'):
    train_dataset = pickle.load(open('weibo_train.pkl','rb'))
else:
    train_dataset = myDataset('weibo_train.txt')
    pickle.dump(train_dataset,open('weibo_train.pkl','wb'))

if os.path.exists('weibo_test.pkl'):
    test_dataset = pickle.load(open('weibo_test.pkl','rb'))
else:
    test_dataset = myDataset('weibo_test.txt')
    pickle.dump(test_dataset,open('weibo_test.pkl','wb'))

if os.path.exists('weibo_dev.pkl'):
    val_dataset = pickle.load(open('weibo_dev.pkl','rb'))
else:
    val_dataset = myDataset('weibo_dev.txt')
    pickle.dump(val_dataset,open('weibo_dev.pkl','wb'))
